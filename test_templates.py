...
class TestModule:
    # TESTCASE FOR RAISED EXCEPTION
    # python -m pytest PATH\FILENAME.py::TestModule::test_FUNCTION
    ...
    @pytest.mark.parametrize(
        "test_input,expected_exception,se_key,st_key",
        [
            (
                a_test_input_1, 
                a_expected_exception_1,
    ...
    def test_FUNCTION(
        ...
        # get the result
        with pytest.raises(expected_exception['exc_type']) as exc_info:
            FUNCTION(
                *test_input['args'],
                **test_input['kwargs']
            )
            assert exc_info.type == expected_exception['exc_type']
...
class TestClass:
    # TESTCASE FOR RAISING EXCEPTION
    # python -m pytest PATH\FILENAME.py::TestModule::test_FUNCITON
    ...
    @pytest.mark.parametrize(
        "test_input,expected_exception,class_,init,attrs",
        [
            (
                a_test_input_1, 
                a_expected_exception_1, 
